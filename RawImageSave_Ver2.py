...
class WalabotRawImageApp:
    ...
    def setup_ui(self):
        ...
        self.save_btn = tk.Button(control_frame, text="Save", command=self.save_image, width=10, bg="#4CAF50", fg="white")
    ...
    def save_image(self):
        if self.current_image is None:
            messagebox.showwarning("Warning", "No image data to save. Please start scanning first.")
            return
